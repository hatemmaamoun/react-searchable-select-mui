...
function SearchableSelect(props) {
    ...
    var label = props.label, error = props.error, searchFieldPlaceholder = props.searchFieldPlaceholder, removeSelectionText = props.removeSelectionText, hideRemoveSelection = props.hideRemoveSelection, value = props.value, onChange = props.onChange, helperText = props.helperText, options = props.options, formControlProps = props.formControlProps, formHelperTextProps = props.formHelperTextProps, showAll = props.showAll, maxVisibleOptions = props.maxVisibleOptions, others = __rest(props, ["label", "error", "searchFieldPlaceholder", "removeSelectionText", "hideRemoveSelection", "value", "onChange", "helperText", "options", "formControlProps", "formHelperTextProps", "showAll", "maxVisibleOptions"]);
    // Customprops
