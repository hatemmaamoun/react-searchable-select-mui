...
function SearchableSelect(props) {
    ...
    function renderGroupedOptions() {
        ...
        return filteredOptions.map(function (group, index) { return (React.createElement(React.Fragment, { key: index },
            React.createElement(core_1.ListSubheader, { style: { background: '#fff' } }, group.title),
